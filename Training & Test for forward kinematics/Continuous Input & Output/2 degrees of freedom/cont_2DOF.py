...
standard manipulator with 2 degrees of freedom using continuous inputs and outputs. After a certain 
...
trained values are saved in the same path as the training file and an error function is plotted.
'''
