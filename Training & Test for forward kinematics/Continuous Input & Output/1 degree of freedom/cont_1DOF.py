...
standard manipulator with 1 degree of freedom. After a certain amount of trainings, the program
...
for e in range(epochs):
    ...
    if e % test == 0:
        ...
        for i in range(500):
            ...
            # are randomly chosen.
            testangles = np.asarray([0, 0, random.choice(angles)])
            # Set the input to a range between 0.01 and 1.00.
...
# Save the trained weight matrices under '1DOF_wih' and '1DOF_who'.
net.save('1DOF')
